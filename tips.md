...
4. You then load packages. I typically start with **janitor**, **naniar** and **patchwork**, if I am going to use them (which I usually do.)
5. Your last two packages loaded are **easystats** then **tidyverse**.
6. You **do not** load packages that are part of easystats or part of the tidyverse separately - this is an *extremely common* problem for people who use AI to help them code, and makes it really tempting for us to take away some points for not being tidy about what you're doing.
...
Be sure to carefully go through the HTML result of your Lab before you submit it to ensure that everything looks OK, and that, for instance, the Table of Contents works properly.
