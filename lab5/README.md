...
Lab 5 requires you to build a professional website, or augment your current one, if you already have one.
...
To complete Lab 5 successfully, you must submit a permanent URL from which Dr. Love has to be able to open your website and read its contents.
...
Submit a link to your website to Dr. Love in an email with the subject line **My Website** by the deadline (in early November) specified in [the Course Calendar](https://thomaselove.github.io/431-2026/calendar.html). In the body of your email, briefly tell me how you created the site (Quarto, or something else.)

Once he's approved your site, Dr. Love will post it for your fellow students to access it.
...
Yes, but you’ll receive 3 points less than than an equivalent site building using Quarto would receive.
...
Lab 5 is worth up to 35 points. Students will receive most (if not all) of the 35 points if their submission:

- is on time,
- is built using Quarto,
- clearly includes [the five key elements listed above](#the-five-key-elements), and
- has no unfixed typos or grammatical issues that Dr. Love notices in his review.

Students will receive a maximum of 32/35 points if their site was built using something other than Quarto, but otherwise meets these standards.
